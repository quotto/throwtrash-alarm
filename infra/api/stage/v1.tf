...
resource "aws_lambda_permission" "throwtrash-delete-permission-apigw-v1" {
    ...
    principal       = "apigateway.amazonaws.com"
    source_arn      = "${var.api_gateway["execution_arn"]}/${aws_api_gateway_stage.api-stage-prod-v1.stage_name}/${var.api_gateway["post_method"]}/${var.api_gateway["delete_path_part"]}"
}
...
resource "aws_lambda_permission" "throwtrash-update-permission-apigw-v1" {
    ...
    principal       = "apigateway.amazonaws.com"
    source_arn      = "${var.api_gateway["execution_arn"]}/${aws_api_gateway_stage.api-stage-prod-v1.stage_name}/${var.api_gateway["post_method"]}/${var.api_gateway["update_path_part"]}"
}
